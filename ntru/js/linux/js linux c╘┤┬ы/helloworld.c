...
unsigned char * Ntrusign(unsigned char *msg,unsigned char *ssk){
...
unsigned char * GetPrivateKey(){
 ...
 unsigned char *Secrect2Pub(unsigned char *skey) {
...
int Ntrusign_Verify(unsigned char * msg,unsigned char * sm, unsigned char * spk,int lenofsm){
