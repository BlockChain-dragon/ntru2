...
enum _PQ_PARAM_SET_ID {
    ...
    Gaussian_512_107,   /* no longer support */
    Gaussian_761_107,   /* no longer support */
    uniform_512_107,    /* no longer support */
    uniform_761_107,    /* no longer support */
    Gaussian_1024_205,
    Uniform_1024_205,
};
...
struct _PQ_PARAM_SET {
    ...
    int64_t          B_k;         /* max infty norm of the F norm for secret keys */
