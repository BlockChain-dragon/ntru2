...
/* check if the polynomial has equal number of +/-1s */
...
/* generate a trinary polynomial with d+1 1s and d -1s */
void
_pol_gen_flat(
          int64_t  *ai,
    const uint16_t  N,
...
/* interface of polynomial multiplications */
void
...
/* interface of polynomial multiplications mod p*/
void
pol_mul_mod_p(
     int64_t         *c,       /* out - address for polynomial c */
     const int64_t   *a,       /*  in - pointer to polynomial a */
